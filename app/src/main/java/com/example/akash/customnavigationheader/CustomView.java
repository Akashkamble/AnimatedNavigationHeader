...
public class CustomView extends View{
    ...
    public void onDraw(Canvas canvas) {
        ...
        paint2.setColor(ContextCompat.getColor(context,R.color.colorAccent)-400);
        paint2.setAntiAlias(true);
        paint2.setShadowLayer(40, 0, 0, Color.DKGRAY);
        setLayerType(LAYER_TYPE_SOFTWARE,paint2);
        canvas.save(canvas.MATRIX_SAVE_FLAG);
        canvas.rotate(rotation*50,canvas.getWidth()/2,canvas.getWidth()/2);
        canvas.drawRect(squareRect2,paint2);
        canvas.restore();

        paint.setAntiAlias(true);
        paint.setColor(ContextCompat.getColor(context,R.color.colorAccent)-200);
        paint.setShadowLayer(40, 0, 0, Color.DKGRAY);
        setLayerType(LAYER_TYPE_SOFTWARE,paint);
        canvas.save(canvas.MATRIX_SAVE_FLAG);
        canvas.rotate(rotation*50,getWidth()/2,getWidth()/2);
        canvas.drawRect(squareRect,paint);
        canvas.restore();

        paint1.setColor(ContextCompat.getColor(context,R.color.colorAccent)+300);
        paint1.setAntiAlias(true);
        paint1.setShadowLayer(40, 0, 0, Color.DKGRAY);
        setLayerType(LAYER_TYPE_SOFTWARE,paint1);
        canvas.save(canvas.MATRIX_SAVE_FLAG);
        canvas.rotate(rotation*50,canvas.getWidth()/2f,canvas.getWidth()/2f);
        canvas.drawRect(squareRect1,paint1);
        canvas.restore();

        paint3.setColor(ContextCompat.getColor(context,R.color.colorAccent)-300);
        paint3.setAntiAlias(true);
        paint3.setShadowLayer(40, 0, 0, Color.DKGRAY);
        setLayerType(LAYER_TYPE_SOFTWARE,paint2);
        canvas.save(canvas.MATRIX_SAVE_FLAG);
        canvas.rotate(rotation*50,canvas.getWidth()/2,canvas.getWidth()/2);
